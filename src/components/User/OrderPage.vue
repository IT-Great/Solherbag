        ...
        <div class="bg-gray-50/50 px-6 py-4 border-t border-gray-100">
          ...
          >
            ...
            >
              ...
              <!-- <button v-if="['completed', 'processing'].includes(order.status)" @click="requestRefund(order.id)" class="hover:bg-gray-100 px-6 py-2 border border-gray-300 rounded-xl font-bold text-gray-600 text-xs uppercase tracking-widest transition w-full md:w-auto">Request to Refund</button> -->
              <button
