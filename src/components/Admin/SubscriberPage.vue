  ...
  >
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
      ...
      <div class="p-6 bg-amber-50/50 rounded-2xl border border-amber-100">
        <p class="text-xs text-amber-600 font-bold uppercase tracking-widest mb-1">
          Guest Subscribers
        </p>
      ...
      <table class="w-full text-left border-collapse">
        ...
        <tbody v-if="isLoading" class="text-gray-600">
          ...
          >
            ...
            <td class="py-6"><div class="h-4 bg-gray-200 rounded w-24 mx-auto"></div></td>
            <td class="py-6 pr-2">
              <div class="h-6 bg-gray-200 rounded w-16 ml-auto"></div>
            </td>
          </tr>
        </tbody>
    ...
    <div
      v-if="showModal"
      class="fixed inset-0 z-50 flex justify-center items-center p-4 bg-black/40 backdrop-blur-sm"
      @click="showModal = false"
    >
      <div
        class="bg-white rounded-3xl p-8 max-w-md w-full shadow-2xl relative"
        @click.stop
      >
        <button
          @click="showModal = false"
        ...
        <h2
          class="text-xl font-bold mb-6 uppercase tracking-widest text-gray-800 border-b pb-4"
        >
          Subscriber Info
        </h2>
