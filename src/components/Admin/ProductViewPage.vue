    ...
    <div v-if="product" class="grid grid-cols-1 gap-12 md:grid-cols-2 animate-fade-in">
      <div class="space-y-4">
        ...
        >
          <img
            v-if="currentMediaType === 'image'"
            :src="currentMediaUrl"
            class="object-cover w-full h-full transition-transform duration-500 hover:scale-[2] cursor-zoom-in main-product-image"
            alt="Product View"
          />
          <video
            v-else-if="currentMediaType === 'video'"
      ...
      <div class="space-y-8">
        <div>
          ...
          <!-- BAGIAN HARGA DAN PERIODE DISKON -->
          <div class="flex flex-col gap-2 mt-6">
            ...
            <!-- 👇 [BARU] INDIKATOR PERIODE DISKON 👇 -->
            <div 
              v-if="product.discount_price && (product.discount_start_date || product.discount_end_date)" 
              class="inline-flex flex-col p-3 mt-3 border bg-red-50 border-red-100 rounded-xl w-fit"
            >
              <p class="text-[10px] font-bold text-red-800 uppercase tracking-widest flex items-center gap-1.5 mb-1">
              ...
              <p class="text-xs font-bold text-red-600">
                {{ formatDateTime(product.discount_start_date) }} - {{ formatDateTime(product.discount_end_date) }}
              </p>
            </div>
          </div>
        ...
        >
                ...
                <div class="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p
                      class="text-[10px] font-medium text-gray-400 mt-0.5 uppercase tracking-wide"
                    >
                      Added: {{ formatDateTime(batch.created_at) }}
                    </p>
                  </div>
                </div>
                <span
          ...
          >
            ...
            <div class="text-right">
              ...
              <p class="text-xs font-bold text-gray-700">
                <!-- Gunakan fungsi formatDateTime yang baru agar seragam -->
...
// 👇 [BARU] FUNGSI FORMAT TANGGAL DAN JAM UNTUK PERIODE PROMO 👇
