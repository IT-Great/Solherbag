...
<template>
  <div class="relative bg-[#F3F4F6] px-6 md:px-12 pt-12 pb-24 min-h-screen">
    ...
    <div class="mx-auto mb-10 max-w-7xl">
      <!-- Header dengan Counter Produk (CRO: Clarity) -->
      <div
      ...
      <div v-if="paginatedProducts.length > 0">
        ...
        >
          ...
          >
            ...
            >
              <!-- Badges Kiri Atas (Diskon & New Arrival) -->
              <div class="absolute z-20 flex flex-col gap-1 top-2 left-2">
                <!-- Diskon (CRO: Merah terang) -->
                <div
                  v-if="
                ...
                <!-- New Arrival (CRO: Dihitung dari tanggal dibuat < 14 hari) -->
                <div
