...
const bagCategories = ref([]);
const isMegaMenuLoading = ref(false);
const randomMegaProduct = ref(null); // 👇 DIUBAH MENJADI REF BUKAN COMPUTED 👇
...
const openMegaMenu = async () => {
  ...
  if (!productState.isCollectionsLoaded) {
    try {
      await fetchCollectionsData();
      generateRandomMegaProduct(); // Setela load berhasil, jalankan acak
    } catch (e) {}
  } else {
    generateRandomMegaProduct(); // Jika sudah ter-load sebelumnya, langsung acak
  }
};
      ...
      >
        ...
        <div class="flex items-center justify-start flex-1">
          ...
          >
            ...
            <!-- 👇 TAMBAHAN STRATEGI CRO: LINK "SALE" MERAH 👇 -->
            <router-link
              to="/collections?filter=final-sale"
              class="transition cursor-pointer text-red-600 hover:text-red-800 font-black flex items-center gap-1"
            >
              <span>{{ $t("header.sale") || "SALE" }}</span>
            </router-link>
            <!-- 👆 ======================================= 👆 -->
        ...
        <!-- Right: Actions (Language, Currency, Search, User, Chat, Wishlist, Cart) -->
        <div
          class="flex items-center justify-end flex-1 space-x-4 text-gray-700 md:space-x-5"
        >
          <div class="items-center hidden gap-3 md:flex">
          ...
          <!-- 👇 TAMBAHAN STRATEGI CRO: IKON WISHLIST 👇 -->
          <button
            @click="openWishlistPage"
            class="relative transition-colors hover:text-black"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
            ...
            <div class="grid w-2/3 grid-cols-4 gap-12">
              ...
              <div class="flex flex-col space-y-4">
                ...
                <router-link
                  to="/collections?filter=final-sale"
                  @click="closeMegaMenu"
                  class="text-[13px] text-red-500 font-bold hover:text-red-700 transition-colors"
                  >Final Sale</router-link
                >
              </div>
          ...
          >
            ...
            <nav class="flex flex-col space-y-6">
              ...
              <router-link
                ...
                @click="isMobileMenuOpen = false"
                class="pb-4 text-sm font-black tracking-widest text-red-600 uppercase transition-colors border-b border-gray-100 hover:text-red-800"
                >{{ $t("header.sale") || "SALE" }}</router-link
              >
...
// 👇 LOGIKA UNTUK MENUJU HALAMAN WISHLIST 👇
const openWishlistPage = () => {
  ...
  router.push("/wishlist"); // Pastikan route '/wishlist' sudah ada di router Anda
};
