          ...
          >
            ...
            >
              <div class="flex items-center justify-center gap-3 mb-1">
                <svg viewBox="0 0 36 30" class="w-8 h-auto drop-shadow-sm opacity-90">
                  <path
                    d="M 0 3 C 12 0, 24 6, 36 3 L 36 15 C 24 18, 12 12, 0 15 Z"
                    fill="#ed2939"
                  />

                  <path
                    d="M 0 15 C 12 12, 24 18, 36 15 L 36 27 C 24 30, 12 24, 0 27 Z"
                    fill="#ffffff"
                  />
                </svg>
                <span>Celebrate</span>
...
<template>
  <section class="relative w-full overflow-x-hidden bg-white">
    ...
    <!-- 👇 [BARU] AFFILIATE / REFERRAL BANNER 👇 -->
    <div v-reveal class="w-full px-6 py-12 text-white bg-[#111]">
      <div class="max-w-[1600px] mx-auto flex flex-col md:flex-row items-center justify-between gap-8 text-center md:text-left">
        <div>
          <h3 class="mb-2 font-serif text-2xl font-light italic md:text-3xl">
            Love Solher? Get Rewarded.
          </h3>
          <p class="max-w-lg text-sm font-light text-gray-400">
            Join our exclusive affiliate program. Share your unique code, give your friends a discount, and earn commissions directly to your bank account on every sale.
          </p>
        </div>
        <router-link 
    ...
    <a 
      href="https://wa.me/628883888585" 
      target="_blank" 
      class="fixed z-50 flex items-center justify-center w-14 h-14 text-white transition-transform duration-300 bg-green-500 rounded-full shadow-2xl bottom-6 right-6 hover:scale-110 hover:bg-green-600 group"
    >
      <!-- Animasi gelombang di belakang tombol -->
      <span class="absolute inline-flex w-full h-full bg-green-400 rounded-full opacity-75 animate-ping"></span>
      <!-- Ikon WhatsApp Asli -->
      <svg xmlns="http://www.w3.org/2000/svg" class="relative z-10 w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
      ...
      <!-- Tooltip -->
      <span class="absolute px-4 py-2 text-[10px] font-bold tracking-widest text-black uppercase transition-opacity duration-300 bg-white rounded-lg shadow-xl opacity-0 right-16 group-hover:opacity-100 whitespace-nowrap">
        Need Help? Chat Us!
      </span>
    </a>
    <!-- 👆 ================================== 👆 -->
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <div class="flex items-center justify-center gap-3 mb-1">
                <svg viewBox="0 0 36 30" class="w-8 h-auto drop-shadow-sm opacity-90">
                  <path d="M 0 3 C 12 0, 24 6, 36 3 L 36 15 C 24 18, 12 12, 0 15 Z" fill="#ed2939" />
                  <path d="M 0 15 C 12 12, 24 18, 36 15 L 36 27 C 24 30, 12 24, 0 27 Z" fill="#ffffff" />
                </svg>
                <span>Celebrate</span>
              </div>
              Independence<br />With 17% Off
            ...
            <p class="text-[14px] md:text-[15px] text-gray-900 font-medium mb-6 leading-snug">
              Up to
              <strong class="font-black text-black">Rp500,000</strong> off, with minimum<br />
              purchase of Rp699,000
            </p>

            <p class="text-[13px] text-gray-800 leading-[1.6] mb-8 w-full max-w-[340px] mx-auto">
              This Independence Day, we're celebrating<br />
              the women who carry their own kind of<br />
              freedom — quietly, gracefully, every day.<br />
              Enjoy 17% off sitewide, today only.
        ...
        >
          ...
          <div class="relative hidden bg-gray-200 md:block md:w-1/2">
            <img src="../../assets/DSCF2551.jpg" alt="Solher Bags" class="object-cover w-full h-full" />
          </div>
          ...
          <div class="flex flex-col items-center justify-center w-full px-6 py-8 overflow-y-auto text-center md:px-8 md:py-10 md:w-1/2 custom-scrollbar">
            ...
            <p class="text-[15px] md:text-[16px] text-gray-800 mb-6 font-serif">
              {{ $t("home.popup_second_cta_section_two") }}
              <span class="font-bold whitespace-nowrap">{{ $t("home.popup_minimum_price_first_section") }}&nbsp;{{ $t("home.popup_minimum_price_second_section") }}</span>
            </p>
