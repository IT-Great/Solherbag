    ...
    <div class="w-full py-24 bg-white border-t border-gray-100">
      <div class="px-6 mx-auto max-w-[1600px]">
        <div v-reveal class="mb-16 text-center">
          ...
          <p class="text-xs font-bold tracking-widest text-gray-500 uppercase">
            Crafted for the modern muse, built to last a lifetime
          </p>
        </div>
        ...
        >
          ...
          <div class="flex flex-col items-center text-center group">
            ...
            <p class="text-sm font-light leading-relaxed text-gray-600">
              Setiap potongan dijahit dengan teliti oleh pengrajin berpengalaman,
          ...
          <div class="flex flex-col items-center text-center group">
            ...
            <p class="text-sm font-light leading-relaxed text-gray-600">
              Hanya menggunakan material pilihan kualitas terbaik yang tahan lama, lembut
              di kulit, dan mempertahankan bentuk aslinya.
            </p>
          </div>
          ...
          <div class="flex flex-col items-center text-center group">
            ...
            <p class="text-sm font-light leading-relaxed text-gray-600">
              Dirancang melampaui tren sesaat. Kami menciptakan karya klasik yang dapat
              Anda padukan untuk berbagai momen istimewa.
            </p>
          </div>
          ...
          <div class="flex flex-col items-center text-center group">
            ...
            <p class="text-sm font-light leading-relaxed text-gray-600">
              Kami percaya pada rantai pasokan yang transparan dan upah yang adil.
              Kecantikan sejati datang dari proses yang bermartabat.
            </p>
          </div>
        </div>
      </div>
