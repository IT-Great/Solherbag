...
<template>
  <div class="max-w-6xl px-4 py-12 mx-auto sm:px-6 lg:py-16 animate-fade-in">
    ...
    >
      ...
      <!-- Waktu Bergabung (Jika ada data created_at dari backend) -->
      <div
    ...
    <!-- 👇 [BARU] WIDGET KELENGKAPAN PROFIL (GAMIFIKASI) 👇 -->
    <div
    ...
    <div v-if="userData" class="grid grid-cols-1 gap-8 lg:grid-cols-12">
      ...
      <div class="space-y-6 lg:col-span-4">
        ...
        <!-- 👇 [BARU] KARTU SOLHER CLUB DENGAN SISTEM TIER 👇 -->
        <div
          ...
          <div class="relative z-10">
            ...
            <div class="mt-8">
              <template v-if="userData.is_membership">
                ...
                <!-- Progress bar menuju tier berikutnya (Opsional visual) -->
    ...
    <!-- Sisa Template (Modal Password, Alamat, Afiliasi) tidak berubah strukturnya, hanya styling UI agar selaras -->
    <!-- (Gunakan block kode di bawah ini untuk memastikan seluruh modal tetap ada) -->
    ...
    <!-- Modal Alamat Leaflet (Sama dengan aslinya) -->
    <div
      v-if="showModal"
      class="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-gray-900/60 backdrop-blur-sm sm:p-6"
    >
