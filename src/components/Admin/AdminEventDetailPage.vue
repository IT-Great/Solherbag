...
<template>
  <div class="p-6 md:p-10 animate-fade-in">
    ...
    <div v-else-if="event" class="flex flex-col items-start gap-6 lg:flex-row">
      <div class="w-full space-y-6 lg:w-1/3 lg:sticky lg:top-24">
        <div class="p-6 bg-white border border-gray-200 shadow-sm rounded-2xl">
          ...
          <h2 class="mb-4 text-2xl font-bold leading-snug text-gray-900">
            {{ event.title }}
          </h2>
      ...
      <div class="w-full lg:w-2/3">
        <div class="p-6 bg-white border border-gray-200 shadow-sm rounded-2xl">
          ...
          <div
            v-else
            class="flex flex-col items-center justify-center py-24 border border-gray-100 border-dashed bg-gray-50 rounded-xl"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
  ...
  <div class="p-6 md:p-10 animate-fade-in">
    ...
    <div class="flex items-center gap-4 mb-8">
      ...
      <div>
        ...
        <p class="mt-1 text-sm text-gray-500">
          Review bilingual information and image gallery for this event.
        </p>
      </div>
    </div>
    ...
    <div v-else-if="event" class="flex flex-col gap-6 lg:flex-row items-start">
      <div class="w-full lg:w-1/3 lg:sticky lg:top-24 space-y-6">
        <div class="p-6 bg-white border border-gray-200 shadow-sm rounded-2xl">
          ...
          <div class="mb-4">
            <h2 class="text-2xl font-bold text-gray-900 leading-snug mb-1">
              🇮🇩 {{ event.title_id }}
            </h2>
            <h3 class="text-lg font-medium text-gray-500 leading-snug">
              🇬🇧 {{ event.title_en || "(No English Title)" }}
            </h3>
          </div>

          <div class="py-4 border-t border-b border-gray-100 my-4">
            <p class="text-xs font-bold tracking-widest text-gray-400 uppercase mb-3">
              Category / Season
            </p>
            <div class="grid grid-cols-2 gap-4">
              <div class="bg-gray-50 p-2.5 rounded-lg border border-gray-100">
                <span
                  class="text-[9px] font-bold text-gray-400 uppercase tracking-widest block mb-1"
                  >Indonesia</span
                >
                <p class="text-sm font-medium text-gray-800">
                  {{ event.season_id || "Not Specified" }}
                </p>
              </div>
              <div class="bg-gray-50 p-2.5 rounded-lg border border-gray-100">
                <span
          ...
          <div>
            ...
            <div class="space-y-3">
              <div class="p-4 bg-gray-50 rounded-xl border border-gray-100">
                <span
                  class="text-[10px] font-bold tracking-widest text-gray-500 uppercase block mb-2"
                  >🇮🇩 Indonesia</span
                >
                <p class="text-sm leading-relaxed text-gray-700 whitespace-pre-wrap">
                  {{ event.description_id || "Tidak ada deskripsi." }}
                </p>
              </div>
              <div class="p-4 bg-gray-50 rounded-xl border border-gray-100">
                <span
                ...
                >
                <p class="text-sm leading-relaxed text-gray-700 whitespace-pre-wrap">
                  {{ event.description_en || "No description provided." }}
                </p>
              </div>
            </div>
          </div>
