<template>
  <div class="min-h-screen bg-[#F9FAFB] flex flex-col max-w-3xl mx-auto pt-20">
    <div
      class="flex items-center px-6 py-4 bg-white border-b border-gray-200 shadow-sm shrink-0"
    >
      <button
        @click="$router.back()"
        class="p-2 mr-4 text-gray-400 transition rounded-full bg-gray-50 hover:text-black hover:bg-gray-200"
      >
        <svg
...
// const token = localStorage.getItem('token'); // Gunakan 'admin_token' untuk versi AdminChatPage
